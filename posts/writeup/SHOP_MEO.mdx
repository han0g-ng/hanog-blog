...
<h1 style={{ textAlign: 'center', color: '#DC321F', fontSize: '2rem', fontWeight: '700' }}>SHOP THÚ CƯNG</h1>
...
<h2 style={{ color: 'white', fontWeight: '700', fontSize: '1.75rem' }}><span style={{ color: '#DC321F', marginLeft: '-1.5rem', marginRight: '0.5rem' }}>#</span> Mở đầu</h2>
...
```
<h2 style={{ color: 'white', fontWeight: '700', fontSize: '1.75rem' }}><span style={{ color: '#DC321F', marginLeft: '-1.5rem', marginRight: '0.5rem' }}>#</span> Bắt đầu thôi</h2>
